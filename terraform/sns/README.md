...
| <a name="module_sns-label"></a> [sns-label](#module\_sns-label) | cloudposse/label/null | ~> 0.25 |
...
| <a name="input_email_endpoint"></a> [email\_endpoint](#input\_email\_endpoint) | Email you want to use as a SNS topic endpoint | `string` | n/a | yes |
